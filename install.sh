...
TARGET_SKILL_DIR="${HOME}/.gemini/config/skills/shake"
TARGET_BIN_DIR="${HOME}/.gemini/bin"

echo "================================================================================"
echo "          ⚡ Antigravity /shake Skill Installation ⚡"
echo "================================================================================"
...
echo "• Skill is now globally available in all Antigravity projects and chat tabs."
echo "• To use it: Type '/shake' in any Antigravity conversation."
echo "================================================================================"
